...
echo color("red","| github: vey251 |\n");
echo color("red","| fanspage :croot|\n");
...
// function change(){
        ...
        echo "\n".color("yellow","!] Claim voc COBAINGOJEKPAY");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $goride1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAINGOJEKPAY"}');
